...
### Task 9: `docs/coach/patterns/3A-core-concepts.md`

**Files:**
- Create: `docs/coach/patterns/3A-core-concepts.md`
- Modify: `tests/foundation.sh`
...
assert_grep "## (Scalability|CAP|PACELC|SPOF)" "docs/coach/patterns/3A-core-concepts.md"
assert_grep "Definition" "docs/coach/patterns/3A-core-concepts.md"
```

- [ ] **Step 2: Run, verify FAIL**

- [ ] **Step 3: Write `docs/coach/patterns/3A-core-concepts.md` following the template above, covering the patterns in `staff-engineer-study-guide.md` §3A** (Scalability, CAP/PACELC, Latency vs Throughput vs Bandwidth, SPOF, Numbers to know, Back-of-envelope estimation).
...
```bash
git add docs/coach/patterns/3A-core-concepts.md tests/foundation.sh
git commit -m "Add pattern reference 3A — core concepts"
```

### Task 10: `docs/coach/patterns/3B-networking-transport.md`
...
### Task 11: `docs/coach/patterns/3C-load-balancing.md`
...
### Task 12: `docs/coach/patterns/3D-storage-databases.md`
...
### Task 13: `docs/coach/patterns/3E-caching.md`
...
### Task 14: `docs/coach/patterns/3F-async-streaming.md`
...
### Task 15: `docs/coach/patterns/3G-consistency-coordination.md`
...
### Task 16: `docs/coach/patterns/3H-data-structures.md`
...
### Task 17: `docs/coach/patterns/3I-api-idempotency.md`
...
### Task 18: `docs/coach/patterns/3J-architectural.md`
...
### Task 19: `docs/coach/patterns/3K-reliability-observability.md`
...
### Task 20: `docs/coach/patterns/3L-security-privacy.md`
...
### Task 21: `docs/coach/patterns/3M-ml-specific.md`
...
### Task 22: `docs/coach/patterns/3N-papers.md`
...
### Task 23: `docs/coach/patterns/3O-tradeoffs.md`
...
- **If `$ARGUMENTS` is an archetype name** (e.g., `concurrent-resource`): resolve to the most-relevant pattern file (e.g., `concurrent-resource` → `3G-consistency-coordination.md`). If ambiguous, ask the user to pick.
...
Check `state/sessions/<date>-study-3G-consistency-coordination.md` — frontmatter or body should record where the session paused.
